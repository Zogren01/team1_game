...
pub fn get_level(id: i8) -> Vec<Descriptor> {
    ...
    result.push(Descriptor::new(1., 2., 2., 16., ObjectType::Barrel)); // platform to hold another item
    //result.push(Descriptor::new(1., 2., 5., 12., ObjectType::Barrel)); // platform to hold another item
