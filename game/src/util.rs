...
pub fn get_level(id: i8) -> Vec<Descriptor> {
    ...
    if id == 1 {
        ...
        result.push(Descriptor::new(1., 2., 6., 1.5, ObjectType::Block));
    ...
    result.push(Descriptor::new(1., 1., -12., -28., ObjectType::UmbrellaItem));// placeholders for landmarker items start
